      ...
      >
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="flex items-center cursor-pointer">
            <img
              src="/public/binary/binarylogo.png" // Replace with your actual image path or source URL
          ...
          <nav className="hidden md:flex items-center gap-6 text-[15px] font-medium text-gray-700">
            <span className="cursor-pointer hover:text-red-500 flex items-center gap-1">
              Services ▾
            </span>
            <span className="cursor-pointer hover:text-red-500">Consulting</span>
            <span className="cursor-pointer hover:text-red-500 flex items-center gap-1">
              Industries ▾
            </span>
            <span className="cursor-pointer hover:text-red-500 flex items-center gap-1">
            ...
            <span className="cursor-pointer hover:text-red-500">News</span>
          </nav>
        </div>

        {/* Right Side: Search Icon */}
        <div className="flex items-center">
          <button className="text-gray-700 hover:text-black p-2 focus:outline-none">
            <svg
